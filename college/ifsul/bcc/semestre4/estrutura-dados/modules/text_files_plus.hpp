 ...
 */
inline bool abrir_arquivo_escrita(std::ofstream &arquivo, const std::string &caminho, bool anexar = false) {
    if (arquivo.is_open()) {
        arquivo.close();
    }
 ...
 */
inline int contar_linhas(std::ifstream &arquivo) {
 ...
 */
inline bool gravar_texto_direto(const std::string &caminho, const std::string &conteudo, bool anexar = false) {
 ...
 */
inline bool ler_arquivo_completo(const std::string &caminho, std::string &conteudoSaida) {
